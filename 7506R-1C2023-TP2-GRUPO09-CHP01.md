...
#     print(len(tokenDeFrase))
#         fila[i] = bytes(fila[i], 'utf-8')
    numericoTest.append(np.array(tokenDeFrase))
    i+=1
```
...
numericoSubmit = []
i=0
for fila in review_pruebas['review_es']:
#     print(fila)
...
#     print(len(tokenDeFrase))
#         fila[i] = bytes(fila[i], 'utf-8')
    numericoSubmit.append(np.array(tokenDeFrase))
    i+=1
```
...
#                             y = y_train)
    ...
    modeloHiper = load('modelos/TP2/rs_redNeuronal.joblib')
