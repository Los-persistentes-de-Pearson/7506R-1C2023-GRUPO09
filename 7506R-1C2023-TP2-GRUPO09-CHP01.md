...
if not exists ('modelos/TP2/ensambleCrossvalidation.joblib.gz'):
    ...
    !gzip modelos/TP2/ensambleCrossvalidation.joblib #Comprimimos

else:
    !gzip -d -k modelos/TP2/ensambleCrossvalidation.joblib.gz #Descomprimimos
