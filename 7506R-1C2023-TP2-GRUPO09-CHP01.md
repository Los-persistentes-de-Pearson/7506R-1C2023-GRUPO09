...
Hay 3 listas hechas a mano debido a que tuvimos que tener cuidado de no incluir palabras cuya raiz exitiera en español o fuesen simples o partes de apellidos (fue hecho manualmente este filtro y es muy porecario) ya que en esos casos se veian contenidas (love-lace-, hate-r, excelent-e). Por Al tener 3 listas con ditintos grupos, fue mas facil armar la lista final. Reconocemos que no es el mejor filtro y que es posible que hayamos eliminado unas pocas rese;as en española y hayan quedado unas pocas en ingleds
...
reviewDf [ reviewDf["review_es"].str.contains('|'.join(lista_completa))]
