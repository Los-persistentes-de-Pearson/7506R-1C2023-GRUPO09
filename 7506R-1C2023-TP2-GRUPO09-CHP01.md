...
resultados_xgb = cross_validate(modelo_final, x_train.review_es, y_train, cv=kfoldcv,scoring=metrica ,return_estimator=True)
...
df_submission.to_csv('NMmejorado5.csv', index=False)
 ```
