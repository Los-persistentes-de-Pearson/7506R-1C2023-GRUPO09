...
parametros = {
    ...
    'tfidfvectorizer__ngram_range': [(1,1), (1,2), (3,1)],
...
Se observa que el modelo tiene un F1-Score bastante parecido a la primera parte del analisis, más sin embargo, el añadido de estos hiperparametros puede ayudar en 
